...
27 Ashbourne Grove, East Dulwich, London UK SE22 8RN
morgan.sziraki@gmail.com +44 779 989 5560
https://www.linkedin.com/in/morganismdev/
[http://git.morganism.dev/](http://git.morganism.dev/)
...
I regularly write publicly available, open source software which is available on GitHub
here: [http://git.morganism.dev/](http://git.morganism.dev/) The README.md will indicate fitness for purpose.
...
Android/iOS package distribution to MSAppCentre, PlayStore,
```
#### AppStore, etc;
...
▪ TeamCity, CI/CD, CodePipeline,
CodeDeploy, Jenkins, CDN
▪ Agile, Scrum, Kanban^
▪ Agile SDLC^
▪ Kafka, rabbit, MQTT^
...
```
▪ Created an online task tracking system; multiple
```
#### deployments

```
▪ Worked with Campus Human Resources to integrate
Resumix, a résumé processing system, with the campus
```
#### website.
